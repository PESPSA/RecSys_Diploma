\begin{titlepage}
	...
	\begin{table}[h!]
		...
		\begin{signstabular}[0.7]{p{7.25cm} >{\centering\arraybackslash}p{4cm} >{\centering\arraybackslash}p{4cm}}
			Студент группы \textbf{ИУ7-82Б} & \uline{\mbox{\hspace*{4cm}}} & \uline{\hfill \textbf{Чалый А. А.} \hfill} \\
		...
		\begin{signstabular}[0.7]{p{7.25cm} >{\centering\arraybackslash}p{4cm} >{\centering\arraybackslash}p{4cm}}
			Руководитель ВКР & \uline{\mbox{\hspace*{4cm}}} & \uline{\hfill \textbf{Русакова З. Н.} \hfill} \\
			& \scriptsize (Подпись, дата) & \scriptsize (И.О. Фамилия)
		\end{signstabular}
		...
		\begin{signstabular}[0.7]{p{7.25cm} >{\centering\arraybackslash}p{4cm} >{\centering\arraybackslash}p{4cm}}
			Нормоконтролер & \uline{\mbox{\hspace*{4cm}}} & \uline{\hfill \textbf{Мальцева Д. Ю.} \hfill} \\
			& \scriptsize (Подпись, дата) & \scriptsize (И.О. Фамилия)
		\end{signstabular}
	\end{table}
